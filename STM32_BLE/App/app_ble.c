...
WEARABLE_APP_ConnHandleNotEvt_t WEARABLEHandleNotification;

static const char a_GapDeviceName[] = { 'B', 'L', 'E', 'W', 'e', 'a', 'r', 'a', 'b', 'l', 'e' }; /* Gap Device Name */
...
uint8_t a_AdvData[] =
{
  ...
  12, AD_TYPE_COMPLETE_LOCAL_NAME, 'B', 'L', 'E', 'W', 'e', 'a', 'r', 'a', 'b', 'l', 'e',  /* Complete name */
  14, AD_TYPE_MANUFACTURER_SPECIFIC_DATA, 0x30, 0x00, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */,
};
...
void APP_BLE_Init(void)
{
  ...
  */
  ...
  /* Make the device discoverable as soon as the GATT database is ready. */
  ...
  case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      WEARABLEHandleNotification.EvtOpcode = WEARABLE_DISCON_HANDLE_EVT;
      WEARABLEHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      WEARABLE_APP_EvtRx(&WEARABLEHandleNotification);
      /* USER CODE BEGIN EVT_DISCONN_COMPLETE */
      /* Return to discoverable mode after a central disconnects. */
      APP_BLE_Procedure_Gap_Peripheral(PROC_GAP_PERIPH_ADVERTISE_START_FAST);
                                      ...
                                      uint16_t Supervision_Timeout)
{
  ...
  WEARABLEHandleNotification.EvtOpcode = WEARABLE_CONN_HANDLE_EVT;
  WEARABLEHandleNotification.ConnectionHandle = Connection_Handle;
  WEARABLE_APP_EvtRx(&WEARABLEHandleNotification);
