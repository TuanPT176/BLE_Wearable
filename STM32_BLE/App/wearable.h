...
typedef enum
{
  ...
  WEARABLE_NFC_DATA_READ_EVT,
  WEARABLE_NFC_DATA_NOTIFY_ENABLED_EVT,
  WEARABLE_NFC_DATA_NOTIFY_DISABLED_EVT,
  WEARABLE_ECG_DATA_READ_EVT,
  WEARABLE_ECG_DATA_NOTIFY_ENABLED_EVT,
  WEARABLE_ECG_DATA_NOTIFY_DISABLED_EVT,
  WEARABLE_DEBUG_DATA_READ_EVT,
  WEARABLE_DEBUG_DATA_WRITE_EVT,
  WEARABLE_DEBUG_DATA_NOTIFY_ENABLED_EVT,
  WEARABLE_DEBUG_DATA_NOTIFY_DISABLED_EVT,
  WEARABLE_RECOVERY_DATA_READ_EVT,
  WEARABLE_RECOVERY_DATA_NOTIFY_ENABLED_EVT,
  WEARABLE_RECOVERY_DATA_NOTIFY_DISABLED_EVT,
